                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: const [
                       AppColumnLayout(firstText: "Flutter",secondText: "passenger",alignment: CrossAxisAlignment.start,isColor: false,),
                       AppColumnLayout(firstText: "5221 857895",secondText: "passport",alignment: CrossAxisAlignment.end,isColor: false),
                      ],
                    ),
                    Gap(AppLayout.getHeight(20)),
                    const AppLayoutBuilderWidget(sections: 15,isColor: false,width: 6),
                    Gap(AppLayout.getHeight(20)),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: const [
                        AppColumnLayout(firstText: "23145 4567885",secondText: "Number of E-Tickets",alignment: CrossAxisAlignment.start,isColor: false,),
                          ...
                          children: [
                            Row(
                               children: [
                                 ...
                                 Text(" **** 2578",style: Styles.headLineStyle3,)
                               ],                               
                            ),
