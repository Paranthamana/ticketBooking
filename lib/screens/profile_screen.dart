                     ...
                     children: [
                       ...
                       Column(
                         ...
                         children: [
                           ...
                           Text("You have 95 flight in a year",style: Styles.headLineStyle2.copyWith(fontWeight: FontWeight.w500, fontSize: 16, color: Colors.white.withOpacity(0.9))),
                         ],
                       )
                     ],
                   ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text("1928092",style: TextStyle(fontSize: 45,color: Styles.textColor,fontWeight: FontWeight.w600)),
                  Gap(AppLayout.getHeight(20)),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                        Text("Miles accrued",style: Styles.headLineStyle4.copyWith(fontSize: 16)),
                        Text("22 Mar 2022",style: Styles.headLineStyle4.copyWith(fontSize: 16)),
                    ],
                  ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: const [
                      AppColumnLayout(firstText: "23 041",
                          alignment: CrossAxisAlignment.start,
                          secondText: "Miles",isColor: false),
                      AppColumnLayout(firstText: "Airline CO",
                          alignment: CrossAxisAlignment.end,
                          secondText: "Received from",isColor: false),
                  ...
                  Row(
                    ...
                    children: const [
                      AppColumnLayout(firstText: "52 340",
                          alignment: CrossAxisAlignment.start,
                          secondText: "Miles",isColor: false),
                      AppColumnLayout(firstText: "Bala",
                          alignment: CrossAxisAlignment.end,
                          secondText: "Received from",isColor: false),
