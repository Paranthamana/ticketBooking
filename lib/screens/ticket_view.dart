    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            /*
            showing blue part of the card/ticket details
            * */
            Container(
              decoration: BoxDecoration(
                color: isColor==null?Color(0xFF526799):Colors.white,
                borderRadius: BorderRadius.only(topLeft: Radius.circular(21),topRight: Radius.circular(AppLayout.getHeight(21))),
              ),
            ...
            /*
            showing orange part of the card/ticket details
            * */
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      AppColumnLayout(firstText: ticket['date'], alignment: CrossAxisAlignment.start, secondText: "Date",isColor: isColor),
                      AppColumnLayout(firstText: ticket['departure_time'], alignment: CrossAxisAlignment.center, secondText: "Depature time",isColor: isColor),
                      AppColumnLayout(firstText: ticket['number'].toString(), alignment: CrossAxisAlignment.end, secondText: "Number",isColor: isColor),
