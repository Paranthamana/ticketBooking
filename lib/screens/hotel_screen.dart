    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(hotel['place'],style: Styles.headLineStyle2.copyWith(color: Styles.hotelColor)),
          Gap(AppLayout.getHeight(10)),
          Text(hotel['destination'],style: Styles.headLineStyle3.copyWith(color: Colors.white)),
          Gap(AppLayout.getHeight(10)),
          Text('\$${hotel['price']}',style: Styles.headLineStyle1.copyWith(color: Styles.hotelColor)),
